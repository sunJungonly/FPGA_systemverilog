        ...
        case (current_state)
            STATE_IDLE: begin
                ...
                if (divided_in_tvalid && divisor_in_tvalid) begin
                    abs_dividend = (divided_in_tdata[DATA_WIDTH-1] < 0) ? -divided_in_tdata : divided_in_tdata;
                    ...
                    abs_divisor_reg_next = (divisor_in_tdata[DATA_WIDTH-1] < 0) ? -divisor_in_tdata : divisor_in_tdata;
                    quotient_reg_next = '0;
