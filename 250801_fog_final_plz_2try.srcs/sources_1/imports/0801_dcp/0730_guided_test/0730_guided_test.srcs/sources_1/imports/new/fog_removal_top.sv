...
module fog_removal_top (
    ...
    parameter DC_LATENCY = 5;  //10;
    parameter TE_LATENCY = 24;  //20;
    ...
    // --- 내부 신호 선언 ---
    logic [DATA_WIDTH-1:0] dc_out, t_out;
    ...
    guided_filter_top Guided_Filter(
        .clk(clk),
        .rst(rst),
        .x_pixel,
        .y_pixel,
    ...
    // // // debugging
    // assign red_port_out = t_out[7:0];
    // assign green_port_out = t_out[7:0];
    // assign blue_port_out = t_out[7:0];
    // assign debug_DE_out = de_te;
