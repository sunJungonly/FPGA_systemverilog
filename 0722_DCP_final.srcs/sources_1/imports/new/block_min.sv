...
module block_min #(
    ...
    logic DE_s5, DE_s6, DE_s7, DE_s8, DE_s9, DE_s10, DE_s11;
    logic [9:0]
        x_pixel_s5,
        x_pixel_s6,
        x_pixel_s7,
    ...
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            DE_s10 <= DE_s9;
            h_sync_s10 <= h_sync_s9;
            v_sync_s10 <= v_sync_s9;
            x_pixel_s10 <= x_pixel_s9;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            DE_s11 <= DE_s10;
            h_sync_s11 <= h_sync_s10;
            v_sync_s11 <= v_sync_s10;
            x_pixel_s11 <= x_pixel_s10;
        end
    end

    //x_pixel_out 을 맞추기 위한 10clk delay
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            h_sync_s12  <= 0;
            v_sync_s12  <= 0;
            ...
            h_sync_s12  <= h_sync_s11;
            v_sync_s12  <= v_sync_s11;
            x_pixel_s12 <= x_pixel_s11;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s13  <= h_sync_s12;
            v_sync_s13  <= v_sync_s12;
            x_pixel_s13 <= x_pixel_s12;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s14  <= h_sync_s13;
            v_sync_s14  <= v_sync_s13;
            x_pixel_s14 <= x_pixel_s13;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s15  <= h_sync_s14;
            v_sync_s15  <= v_sync_s14;
            x_pixel_s15 <= x_pixel_s14;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s16  <= h_sync_s15;
            v_sync_s16  <= v_sync_s15;
            x_pixel_s16 <= x_pixel_s15;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s17  <= h_sync_s16;
            v_sync_s17  <= v_sync_s16;
            x_pixel_s17 <= x_pixel_s16;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s18  <= h_sync_s17;
            v_sync_s18  <= v_sync_s17;
            x_pixel_s18 <= x_pixel_s17;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s19  <= h_sync_s18;
            v_sync_s19  <= v_sync_s18;
            x_pixel_s19 <= x_pixel_s18;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s20  <= h_sync_s19;
            v_sync_s20  <= v_sync_s19;
            x_pixel_s20 <= x_pixel_s19;
        end
    end
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin  // BUG FIX: 리셋 로직 추가
            ...
            h_sync_s21  <= h_sync_s20;
            v_sync_s21  <= v_sync_s20;
            x_pixel_s21 <= x_pixel_s20;
        end
    end
    ...
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            DE_out      <= DE_s11;
            h_sync_out  <= h_sync_s21;
            v_sync_out  <= v_sync_s21;
            x_pixel_out <= x_pixel_s21;
        end
    end
