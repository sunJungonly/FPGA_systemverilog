...
module Line_Buffer_for_DCP #(
    ...
    output logic [$clog2(IMAGE_WIDTH)-1:0] y_pixel_out
);
    ...
    logic [$clog2(IMAGE_WIDTH)-1:0] y_pixel_d1;
    logic [1:0] counter;
    ...
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            counter <= 0;
        end else if (x_pixel != x_pixel_d1) begin
            counter <= 0;
        end else begin
            counter <= counter + 1;
            if (counter == 2) begin
