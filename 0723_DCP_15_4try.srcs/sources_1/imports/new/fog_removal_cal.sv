...
module fog_removal_cal #(
    ...
    //     .divisor_in_tdata (tx_value),
    //     .divisor_in_tvalid(DE_s1),
    //     .divisor_in_tready(),

    //     .divided_out_tdata (removal_data_r_raw),
    //     .divided_out_tvalid(r_valid_out)
    // );

    assign removal_data_r_raw = value_tem_r / {8'b0, tx_value};
    assign removal_data_g_raw = value_tem_g / {8'b0, tx_value};
    assign removal_data_b_raw = value_tem_b / {8'b0, tx_value};
    ...
    //     .divided_out_tdata (removal_data_g_raw),
    ...
    //     .divided_out_tdata (removal_data_b_raw),
