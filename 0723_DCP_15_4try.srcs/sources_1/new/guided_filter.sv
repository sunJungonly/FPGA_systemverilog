...
module window_sum_calculator #(
    ...
    logic [8:0] x_pixel_d1, x_pixel_d2, x_pixel_d3;
    logic [8:0] y_pixel_d1, y_pixel_d2;
    logic DE_d1, DE_d2;
...
module AB_Calculator #(
    ...
    logic [SUM_I_WIDTH-1:0] sum_i_delayed [0:DIVIDER_LATENCY-1];
    logic [SUM_P_WIDTH-1:0] sum_p_delayed [0:DIVIDER_LATENCY-1];
    ...
    assign a_k_out = quotient_from_ip[67:48];
