...
module sort15#(
    ...
    input [DATA_WIDTH:0]      data2, 
    input [DATA_WIDTH:0]      data3,
    input [DATA_WIDTH:0]      data4,
    input [DATA_WIDTH:0]      data5,
    input [DATA_WIDTH:0]      data6,
    input [DATA_WIDTH:0]      data7,
    input [DATA_WIDTH:0]      data8,
    input [DATA_WIDTH:0]      data9,
    input [DATA_WIDTH:0]      data10,
    input [DATA_WIDTH:0]      data11,
    input [DATA_WIDTH:0]      data12,
    input [DATA_WIDTH:0]      data13,
    input [DATA_WIDTH:0]      data14,
    input [DATA_WIDTH:0]      data15,
    
    output reg [DATA_WIDTH:0] min_data
);
